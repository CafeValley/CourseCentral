...
maincheckRegis("GateLost");
if (isset($_POST['RegisterID'])) {
    $Regisid = $_POST['RegisterID'];
    $linkGate = "<script>window.open('gatepass.php?Regisid=$Regisid', '_blank', 'toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=400, height=400')</script>";
    echo $linkGate;
    $COCO = 'D';
                ...
                <div class="span12">
                    <div class="widget ">
                        <div class="widget-header">
                            ...
                            <h3>Student Gate Pass</h3></div>
                        <div class="widget-content">
                            <div class="tabbable">
                                <div class="tab-content">
                                    <form action = "LostGatePass.php" method = "POST">
