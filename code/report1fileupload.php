...
<div class = "main">
	...
	<?php require_once "common_scripts.php"; ?>
							...
							<div class = "tabbable">
								<div class = "tab-content">
									<div class = "tab-pane active" id = "jscontrols">
										<form action = "report1fileupload.php" method = "POST" enctype="multipart/form-data">     
										...
										**********************************
										...
										if (isset($Fname)) {
											?>
											<form action = "report1fileupload.php" method = "POST" enctype="multipart/form-data">  
											<input type = "hidden" name = "StudentCode" value = "<?php echo $_POST['StudentCode'];?>">
											<div class = "controls">
												<div class = "input-append"><label class = "control-label"
												                                   for = "radiobtns">Student
														Name</label>
		...
		<?php
			// DISABLED - Second database concor_fileholder not in use
			// $result=mysqli_query($link2nd ,"select * from file where filetowho = '$StudentId'  ") or die("".mysql_error());
			// while($row=mysqli_fetch_array($result)){
			$result = array(); // Empty array to prevent errors
			while(false){ // Disabled loop
				$row = array(); // Prevent undefined variable errors
		?>	
<form action = "report1fileupload.php" method = "POST">
		<?php
